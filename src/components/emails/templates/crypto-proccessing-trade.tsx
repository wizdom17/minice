...
interface ProcessingCryptoTradeEmailProps {
  username?: string;
  tradeId?: string;
  tradeType?: string;
  fromCrypto?: string;
...
export const ProcessingCryptoTradeEmail = ({
  ...
  submissionDate = "April 17, 2025 at 3:15 PM",
  networkFee = "0.0005 BTC",
}: ProcessingCryptoTradeEmailProps) => {
  const baseUrl = "";
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your Crypto {tradeType} from {fromCrypto} to {toCrypto} is Being
        Processed - MiniCEX
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            <Heading style={h1}>Crypto Trade In Progress</Heading>
            <Text style={heroText}>
              Hi {username}, we're currently processing your {fromCrypto} to{" "}
              {toCrypto} {tradeType.toLowerCase()}.
            </Text>
          </Section>
            ...
            <Row style={stepsRow}>
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  ...
                  <br />
                  Your trade request has been received.
                </Text>
              </Column>
              ...
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  <strong>Blockchain Confirmation</strong>
                  <br />
              ...
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  ...
                  <br />
                  {toCrypto} will be added to your wallet.
                </Text>
              </Column>
            </Row>

            <Text style={noteText}>
              <strong>Note:</strong> Cryptocurrency transactions require
              blockchain confirmations which can vary in time depending on
              network congestion. The estimated completion time is approximate.
            </Text>
          </Section>
...
export default ProcessingCryptoTradeEmail;

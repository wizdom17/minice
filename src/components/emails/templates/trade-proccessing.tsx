...
interface ProcessingTradeEmailProps {
  username?: string;
  tradeId?: string;
  giftCardType?: string;
...
export const ProcessingTradeEmail = ({
  username = "Valued Customer",
  tradeId = "GCT123456789",
  giftCardType = "Amazon",
  ...
  submissionDate = "April 17, 2025 at 12:30 PM",
}: ProcessingTradeEmailProps) => {
  const baseUrl = "";
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your {giftCardType} Gift Card Trade is Being Processed - MiniCEX
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            <Heading style={h1}>Trade In Progress</Heading>
            <Text style={heroText}>
              Hi {username}, we're currently processing your {giftCardType} gift
              card trade.
            </Text>
          </Section>
          ...
          <Section style={section}>
            ...
            <Section style={detailsContainer}>
              ...
              <Row style={detailRow}>
                <Column style={detailLabel}>Gift Card:</Column>
                <Column style={detailValue}>
                  {giftCardType} ({giftCardAmount} {giftCardCurrency})
                </Column>
              </Row>
              <Row style={detailRow}>
                <Column style={detailLabel}>Expected Value:</Column>
                <Column style={detailValue}>
            ...
            <Section style={ctaContainer}>
              <Button style={button} href="https://minicex.com/trades/status">
                Check Trade Status
              </Button>
            </Section>
          </Section>
            ...
            <Row style={stepsRow}>
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  ...
                  <br />
                  We're verifying your gift card details and balance.
                </Text>
              </Column>
              ...
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  ...
                  <br />
                  We'll process the gift card and prepare your funds.
                </Text>
              </Column>
              ...
              <Column style={stepContainer}>
                ...
                <Text style={stepText}>
                  ...
                  <br />
                  Funds will be added to your MiniCEX account.
                </Text>
              </Column>
            </Row>

            <Text style={noteText}>
              <strong>Note:</strong> Processing times may vary based on gift
              card type and verification requirements. You'll receive another
              email once your trade is complete.
            </Text>
          </Section>
          ...
          <Section style={section}>
            <Heading as="h2" style={h2}>
              Questions About Your Trade?
            </Heading>
            <Text style={text}>
              If you didn't initiate this trade or have any concerns, please
...
export default ProcessingTradeEmail;

...
const CryptoSec = ({ data, crypto }: { data: any; crypto: Crypto[] }) => {
            ...
            <div className="mt-10">
              <div>
                ...
                <Select onValueChange={(val) => setSelectedNetwork(val)}>
                  ...
                  <SelectContent>
                    {cryptoData?.address.map((item: any) => (
                      <SelectItem
                        key={item.chain}
                        value={item.chain}
              ...
              {selectedNetwork && (
                <div className="mt-10">
                  ...
                  <div className="flex p-5 rounded-md border text-xs my-10 text-orange-400 border-orange-400 bg-amber-200">
                    <p>

...
export default function TradesTable({ data }: { data: Trade[] }) {
              ...
              {data.length > 0 ? (
                data.slice(0, 5).map((transaction) => (
                  <TableRow key={transaction.id}>
                    ...
                    {/* <TableCell>GBP{transaction.value}/₦{transaction.rate}</TableCell> */}
                    <TableCell>
                      <div className="flex flex-col">
                        <p>{transaction.value}-{transaction.currency}</p>₦{transaction.rate}
                      </div>
                    </TableCell>
